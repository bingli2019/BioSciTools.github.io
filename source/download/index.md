...
<body>
  ...
  <div style="border-radius: 10px; background: #008000aa; box-shadow: 0px 0px 10px #00800088; padding: 20px; line-height: 30px;">
    ...
    <br/>
    <b>Download1 (SourceForge):</b> <a href="https://sourceforge.net/projects/bioscitools-github-io/files/latest/download" style="color: #ffffff">BioSciTools-v1.3.4 [Windows]</a> <br />
    <b>Download2 (AliyunDrive):</b> <a href="https://www.aliyundrive.com/s/Defuhf7FVGw" style="color: #ffffff">BioSciTools-v1.3.4 [Windows]</a> <br />
    <b>Download3 (Github Release):</b> <a href="https://github.com/BioSciTools/BioSciTools.github.io/releases/download/v1.3.4/BioSciTools-v1.3.4.exe" style="color: #ffffff">BioSciTools-v1.3.4 [Windows]</a> <br />
    <hr />
  ...
  <div style="border-radius: 10px; background: #efefef; box-shadow:  20px 20px 60px #cdcdcd, -20px -20px 60px #ffffff; padding: 20px; line-height: 20px; font-family: 'SimHei'; font-size: 14px; text-align: justify;">
    <h3>BioSciTools-v1.3.4</h3>
    <b>Date: 2023-03-04</b> <br />
    <b>Update: <a href="https://mp.weixin.qq.com/s/mvkuJv95T8wsFcxK6_NDxg" style="color: #008000">生物信息学Omics: https://mp.weixin.qq.com/s/mvkuJv95T8wsFcxK6_NDxg</a> <br /> </b>
    <p><b>UI Design:</b> 1.1 Add the OpenExample button at the bottom of the table window for all programs, which is convenient for users to find the program sample data and prepare the data structure suitable for the program according to the sample data (为所有程序在表格窗口下方添加OpenExample按钮，方便用户找到程序示例数据，并根据示例数据准备适合程序的数据结构).
    <p><b>New App:</b> 2.1 There are three new procedures for genome gene density and two/three genome collinearity analysis in Genomics genome classification, including genome density, digenomesynty and trigenomesynty.
    ...
    <p><b>New App:</b> 2.3 Eight Metabolomics programs based on the original analysis of LC-MS mass spectrometry data mzML have been added to the metabolomics metabolomics classification, including metabomZML, metabomHeatmap, metaboroi, metabobasepeakion, metabotaliochrom, metabopeakintensity, metabopeakrt and metabopeakanno.
    <p><b>Bug Fixed:</b> 3.1 Solve the analysis process interruption and task failure caused by Chinese user names of some users. This update will be suitable for most Windows computer environments (解决部分用户由于中文用户名导致的分析进程中断及任务失败，此次更新将适合于大多数Windows电脑环境).
  </div>
  <hr />
